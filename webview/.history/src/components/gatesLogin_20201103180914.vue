  ...
  <div>
    ...
    <div>
      ...
      <b-input-group
        ...
        class="mt-3"
      >
        <b-form-input v-model="loginData.password" type="password"></b-form-input>
      </b-input-group>
      <br>
      <b-button
        @click="login()"
      ...
      >登陆</b-button>
      <br>
      <b-card-text style="font-size: 12px; margin-top: 10px;">还没有账号？请<router-link to="#">注册</router-link></b-card-text>
    </b-card>
</div>
  </div>
</template>
